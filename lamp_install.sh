...
if [ "${OSNAME}" = "debian" ]; then
    ...
    if [ "${DEB_VERSION}" = "10" ]; then
        pkglist="${pkglist} php-mbstring php-zip php-gd php-xml php-pear php-gettext php-cgi php-mysqli"
...
EOF
    ...
    pkglist="vim nginx httpd php php-pdo php-pecl-zip php-json php-common php-fpm php-mbstring php-cli php-mysqlnd php-json php-mbstring wget unzip tar pwgen"
    if [ "${OSREL}" -ge 7 ]; then
